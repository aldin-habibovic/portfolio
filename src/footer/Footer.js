...
const Footer = () => {
    return (
        <footer className="footer">
            ...
            <div className="h4 title text-center">Aldin Habibović</div>
            <div className="text-center text-muted">
                <p>&copy; Creative CV. All rights reserved.<br />Design - <a className="credit" href="https://templateflip.com" target="_blank" rel="noopener noreferrer">TemplateFlip</a></p>
            </div>
        </footer>
    );
}
